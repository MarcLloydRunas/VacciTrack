...
<div class="table-responsive table-hover" id="gencon">
		...
		<div class="container-fluid">
			<div class="row g-0" id="age_pad" style="background-color: lightgray; align-items: center; margin: auto; padding: 7px; border-radius: 4px;">
				...
				<div class="col-md-3">
					<form name="change_vacc_age" id="change_vacc_age" method="POST" action="">
				          <div class="col-5">
					          <select id="vaccine_name_age" name="vaccine_name_age" class="form-select-sm" value="{{ old('vaccine_name_age') }}" onchange="this.form.submit()" >
					          <option>
					          	<?php 
...
<script type="text/javascript">
	...
	{
		$.ajax({
			url:"../admin/data_admin/agedata.php",
			method:"POST",
			data:{action:'fetch'},
			dataType:"JSON",
	...
	{
		$.ajax({
			url:"../admin/data_admin/sexdata.php",
			method:"POST",
			data:{action:'fetch'},
			dataType:"JSON",
			success:function(data)
		...
		{
			$.ajax({
				url:"../admin/data_admin/graphdata.php",
				method:"POST",
				data:{action:'fetch'},
				dataType:"JSON",
				success:function(data)
		...
		{
			$.ajax({
				url:"../admin/data_admin/vaccdata.php",
				method:"POST",
				data:{action:'fetch'},
				dataType:"JSON",
				success:function(data)
